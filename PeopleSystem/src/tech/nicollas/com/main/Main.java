package tech.nicollas.com.main;

import tech.nicollas.com.pessoas.Cliente;
import tech.nicollas.com.pessoas.Funcionario;
...
public class Main {
    private static List<Cliente> clientes = new ArrayList<>();    // LISTA CLIENTES
    private static List<Funcionario> funcionarios = new ArrayList<>(); // LISTA FUNCIONARIOS
    ...
    // METODOS PARA GERENCIAR FUNCIONARIOS
